...
public class Test_Pathfinding extends Application
{
    ...
    private void buildAxes() {
        ...
        Image image = new Image(getClass().getResourceAsStream("general/stonebricks1.jpg"));
        Image image_s = new Image(getClass().getResourceAsStream("general/stonebricks1_s.jpg"));
